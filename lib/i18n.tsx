...
export const TRANSLATIONS = {
  ckb: {
    ...
    heroDescription:
               "هەرچی پێویستت بە بازیان هەیە لێرەیە؛ ڕێنمایی گشتی، ژمارەی بەپەلە و خزمەتگوزارییە ڕۆژانەیییەکان؛ (مارکێت، چێشتخانە، تاکسی، گەیاندن و وەستای تایبەت) لە یەک پلاتفۆرمدا.",    searchPlaceholder: "      گەڕان لە خزمەتگوزاری و بازرگانی...",
